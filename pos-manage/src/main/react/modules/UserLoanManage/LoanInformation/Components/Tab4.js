...
var Tab4 = React.createClass({
  ...
  render() {
    ...
    var htmlArray = [];
    var dataProd = props.riskRecord.applyInfoDO.dataProd;
    ...
    return (
        ...
        <Row>
          <Col span="8">
              <span>姓名：</span>
              <span>{props.riskRecord.applyInfoDO.nameCustc}</span>
          </Col>
          <Col span="8">
        	<span>证件号码：</span>
        	<span>{props.riskRecord.applyInfoDO.idCard}</span>
          </Col>
        ...
        <Col span="8">
	        <span>手机号：</span>
	        <span>{props.riskRecord.applyInfoDO.mobile}</span>
	      </Col>
        <Col span="8">
          	<span>现居地址：</span>
            <span>{props.riskRecord.applyInfoDO.abodeAdd}</span>
        </Col>
      </Row>
          {htmlArray}
        </div>
