...
var Lookdetails = React.createClass({
  ...
  render() {
    ...
    var viewurl = props.form.getFieldProps('viewpdfUrl').value;
    var downloadUrl = props.form.getFieldProps('downloadUrl').value;
    var url;
    if (viewurl!=null && downloadUrl!=null) {
		url=<div style={{margin:'15px 500px 15px 200px'}}>
          合同在线查看地址: <a target='_blank' href={viewurl}>点击查看</a>
               &nbsp;&nbsp;&nbsp;&nbsp; <a target='_blank' href={downloadUrl}>点击下载</a>
              </div>;
	}
        ...
        <Form horizontal form={this.props.form}>
          ...
          <Row>
	        ...
	        <Col span="12">
	            ...
	            <Input disabled={!props.canEdit} type="text" {...getFieldProps('remark', { initialValue: '' }) } style={{border:'none', background:'#FFF', display:'block'}}/>
	          </FormItem>
	        </Col>
          </Row>
          {url}
