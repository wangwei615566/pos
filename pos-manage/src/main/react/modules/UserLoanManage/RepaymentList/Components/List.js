    ...
    fetch(params = {}) {
        ...
        if (!params.pageSize) {
            ...
            params = {
                pageSize: 10,
                current: 1,
                searchParams: JSON.stringify({startDate:year+'-'+month+'-'+day+' 00:00:00',endDate:year1+'-'+month1+'-'+day1+' 23:59:59',state:"40"}),
            }
        }
        if(!params.searchParams){
            params.searchParams= JSON.stringify({startDate:year+'-'+month+'-'+day+' 00:00:00',endDate:year1+'-'+month1+'-'+day1+' 23:59:59',state:"40"});
        }
        Utils.ajaxData({
