...
let SeachForm = React.createClass({
    ...
    handleQuery() {
        ...
        var json = {startDate:'',endDate:'',realName:params.realName,phone:params.phone,orderNo:params.orderNo,state:"90"};
        //console.log(params);
        if(params.time[0]){
    ...
    handleOut() {
        ...
        window.open("/modules/manage/badDebt/export.htm?searchParams="+encodeURIComponent(json));
