      ...
      <Modal title={props.title} visible={props.visible} onCancel={this.handleCancel} width="900" footer={[<button key="back" className="ant-btn" onClick={this.handleCancel}>关闭</button>]} maskClosable={false} >
        <Form horizontal form={this.props.form}>
          ...
          <Row>
            ...
            <Col span="12">
              <FormItem  {...formItemLayout} label="应还款时间:">
                <Input disabled={!props.canEdit} type="text" {...getFieldProps("repaymentTime", { initialValue: '' }) } style={{border:'none', background:'#FFF', display:'block'}}/>
              </FormItem>
            </Col>
            <Col span="12">
          ...
          <Row>
            ...
            <Col span="12">
              <FormItem {...formItemLayout} label="逾期等级:">
                <Input disabled={!props.canEdit} type="text" {...getFieldProps('level', { initialValue: '' }) } style={{border:'none', background:'#FFF', display:'block'}}/>
              </FormItem>
            </Col>
          </Row>
          <Row>
