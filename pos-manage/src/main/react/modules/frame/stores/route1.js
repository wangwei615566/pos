...
var LoanAuditList = require('../../RiskControlManage/LoanAuditList/index');//放款审核列表
var FinanceSettlement = require('../../ReportForm/FinanceSettlement/index');//报表-财务结算
var OverdueOrderExport = require('../../ReportForm/OverdueOrderExport/index');//报表-逾期15天报表
var RepaymentStatistics = require('../../ReportForm/RepaymentStatistics/index');//报表-应还统计
var RiskControlDataDynamicStatistics = require('../../ReportForm/RiskControlDataDynamicStatistics/index');//报表-风控数据统计（动态）
var RiskControllerStatistics = require('../../ReportForm/RiskControllerStatistics/index');//报表-风控数据统计
...
module.exports = {
  ...
  OverdueOrderExport,
  RepaymentStatistics,
  RiskControlDataDynamicStatistics,
  RiskControllerStatistics
}