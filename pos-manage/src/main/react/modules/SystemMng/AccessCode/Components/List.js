...
export default React.createClass({
    ...
    delete(text, record) {
        ...
        confirm({
            ...
            onOk: function () {
                Utils.ajaxData({
                    url: "/modules/manage/user/accessCode/delete.htm",
                    data: {
                        id: record.id,
                    },
                    method: 'post',
    ...
    render(text,record) {
            ...
            render(text, record) {
                return (
                    <div style={{ textAlign: "left" }}>
                      ...
                      &nbsp;&nbsp;<a href="#" onClick={me.showModal.bind(me,'编辑',record,true)}>编辑 </a>&nbsp;&nbsp;<a href="#" onClick={me.delete.bind(me,'删除',record)}>删除</a>
                    </div>
                )
            }
        }];
        ...
        return (
            <div className="block-panel">
              ...
              <Table columns={columns} rowKey={this.rowKey} params={this.props.params}
