...
let SeachForm = React.createClass({
  ...
  handleOut() {
        ...
        window.open("/modules/manage/borrow/tongdun/export.htm?searchParams="+encodeURIComponent(json));
  ...
  render() {
    ...
    return (
      <Form inline >
        ...
        <FormItem label="订单号：">
          <Input onPressEnter={this.handleQuery} {...getFieldProps('borrowNo', { initialValue: '' }) } />
        </FormItem>
        <FormItem label="风险报告编码：">
          <Input onPressEnter={this.handleQuery} {...getFieldProps('reportId', { initialValue: '' }) } />
        </FormItem>
