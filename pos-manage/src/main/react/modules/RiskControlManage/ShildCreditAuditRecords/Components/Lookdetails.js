         ...
         <Row>
            <Col span="12">
              <FormItem  {...formItemLayouttwo} label="查询审核报告信息:" >
                {props.detail?(state.show? <a href="#" onClick={this.show}><Icon type="minus-square" /></a> : <a href="#" onClick={this.show}><Icon type="plus-square" /></a>):''}
                <div style={{width:'600px',wordWrap:'break-word',wordBreak:'break-all' }}>{props.detail? (state.show ? props.detail.queryParams :(JSON.stringify(props.detail.queryParams)).substring(0,250)+'...') :""}</div>
              </FormItem>
            </Col>
         </Row>
        </Form>
