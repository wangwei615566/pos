...
export default React.createClass({
        ...
        Utils.ajaxData({
            ...
            callback: (result) => {
                ...
                this.setState({
                    loading: false,
                    data: result.data,
                    countChannelName:result.countChannelName,
                    pagination
                });
            }
        });
  ...
  onSelectAll(selected, selectedRows, changeRows) {
    ...
    render() {
        ...
        //console.log(this.state.countChannelName);
        var channelList = [];
        if(this.state.countChannelName){
            this.state.countChannelName.map(item => {
              channelList.push(<div style={{color:"blue"}}>{item.name}:{item.count}  </div>)
            })
          }
        return (
