...
export default React.createClass({
    ...
    showModal(title, record, canEdit) {
        ...
        this.setState({
            ...
            canEdit: canEdit,
            rowRecord: record,
            title: title + "【渠道来源："+record.channelName+"】"+(record.platformName==null?"":" 【引流平台："+record.platformName+"】"),
            keyModal: Date.now(),
        }, () => {
            Utils.ajaxData({
            ...
            //console.log(record);
            //record.state1 = title == "人工复审" ? "22" : record.state;
    ...
    render() {
        ...
        var columns = [{
            ...
            title: '引流平台',
            render(text, record) {
	            if (record.platformName == null) {
	            	return (
                          <div title={record.platformName} style={{ textAlign: "left" }}>
                          	-                      	
                          </div>
	                 ) 
	            } else {
