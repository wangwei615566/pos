...
export default React.createClass({
    ...
    fetch(params = {}) {
        ...
        Utils.ajaxData({
            url: '/modules/manage/surplusOrder/surplusOrderDate/list.htm',
            data: params,
            method: 'post',
            callback: (result) => {
    ...
    changeStatus(title, record) {
        ...
        if (title == "禁用") {
            ...
            url = "/modules/manage/surplusOrderPlatform/disable.htm";
        } else {
            data = {
                id: record.id,
            }
            url = "/modules/manage/surplusOrderPlatform/enable.htm";
        }
        confirm({
            title: '是否确认',
            onOk: function () {
