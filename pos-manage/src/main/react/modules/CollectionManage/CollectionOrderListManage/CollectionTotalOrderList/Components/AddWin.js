...
var AddWin = React.createClass({
    ...
    handleOk() {
        ...
        this.props.form.validateFields((errors, values) => {
            ...
            var d = new Date(values.createTime);  
                        ...
                        <Row>
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="催收时间:">
                                    <DatePicker disabled={true} style={{width:'100%'}} type="text" format="yyyy-MM-dd HH:mm:ss" {...getFieldProps('createTime', { rules: [{required:true,message:'必填',type:'date'}] }) } />
                                </FormItem>
                            </Col>
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="催收结果:">
                                    <Select type="text" disabled={true} {...getFieldProps('state1', { rules: [{required:true,message:'必填',type:'string'}] }) } >
                        ...
                        <Row>
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="承诺还款时间:">
                                    <DatePicker style={{width:'100%'}} disabled={true} type="text" format="yyyy-MM-dd HH:mm:ss" {...getFieldProps('promiseTime', { rules: [{required:true,message:'必填',type:'date'}] }) } />
                                </FormItem>
                            </Col>
                            <Col span="12">
                                <FormItem  {...formItemLayout} label="催收方法:">
                                    <Select style={{ width: '100%' }} disabled={true} placeholder="请选择"  {...getFieldProps('way',{ rules: [{ required: true, message: '必填' }] })}>
                        ...
                        <Row>
                            <Col span="24">
                                <FormItem  labelCol={{span: 4}} wrapperCol={{span:16}} label="催收反馈:">
                                    <Input type="textarea" disabled={true} {...getFieldProps('remark') } />
                                </FormItem>
                            </Col>
                        </Row>
                    </Form>
