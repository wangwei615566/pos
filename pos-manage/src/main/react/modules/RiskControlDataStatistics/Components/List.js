...
export default React.createClass({
    ...
    fetch(params = {}) {
        ...
        Utils.ajaxData({
            url: '/modules/manage/rcdata/statistics/page.htm',
            method: "post",
            data: params,
            callback: (result) => {
    ...
    changeStaus(title,record){
        ...
        var urlStr = title == "禁用"?"/modules/manage/rcdata/statistics/disable.htm":"/modules/manage/rcdata/statistics/enalbe.htm";
        Utils.ajaxData({
            url:urlStr,
            data:params,
            callback:(result)=>{
