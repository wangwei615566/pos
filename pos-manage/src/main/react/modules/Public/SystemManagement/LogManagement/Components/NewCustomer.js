              ...
              <div className="ant-form-item"> 
                    ...
                    <div className="col-8">
                      <div className={this.renderValidateStyle('is_loan', false)}>
                        <Validator rules={[{required: true, message: '请选择所属部门'}]}>
                          <Select size="large"  disabled={!props.canEdit} style={{width:"80%"}} name="is_loan" value={formData.is_loan} onSelect={this.selectChange.bind(this, 'is_loan')}>
                    ...
                    <div className="col-8">
                      <div className={this.renderValidateStyle('is_repayment', false)}>
                        <Validator rules={[{required: true, message: '请选择所属部门'}]}>
                          <Select size="large"  disabled={!props.canEdit} style={{width:"80%"}} name="is_repayment" value={formData.is_repayment} onSelect={this.selectChange.bind(this, 'is_repayment')}>
                              <Option value="1">启用</Option> 
                              <Option value="0">禁用</Option> 
                          </Select> 
                        </Validator>
