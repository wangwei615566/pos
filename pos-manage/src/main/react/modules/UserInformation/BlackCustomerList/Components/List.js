...
export default React.createClass({
  ...
  render() {
    ...
    var columns = [{
      ...
      title: '借款时间',
      render(text, record) {
          if (record.borrowTime == null) {
          	return (
                    <div title={record.borrowTime} style={{ textAlign: "left" }}>
                    	-                      	
                    </div>
               ) 
          } else {
      ...
      title: '应还款时间',
      render(text, record) {
          if (record.repayTime == null) {
          	return (
                    <div title={record.repayTime} style={{ textAlign: "left" }}>
                    	-                      	
                    </div>
               ) 
          } else {
    	...
    	render(text, record) {
            if (record.level == null) {
            	return (
                      <div title={record.level} style={{ textAlign: "left" }}>
                      	-                      	
                      </div>
                 ) 
            } else {
        ...
        render(text, record) {
          return <div>
          			<a href="javascript:;" onClick={me.showModal.bind(me, '查看', record, true)}>查看</a>
          			<span className="ant-divider"></span>
                    <a href="javascript:;" onClick={me.changeStatus.bind(me,'解除黑名单',record)}>移除黑名单</a>
                 </div>
        }
      }];
