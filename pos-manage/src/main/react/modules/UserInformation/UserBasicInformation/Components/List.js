  ...
  render() {
    ...
    var columns = [{
      ...
      render(text, record) {
          if (record.realName == null) {
          	return (
                    <div title={record.realName} style={{ textAlign: "left" }}>
                    	-                      	
                    </div>
               ) 
          } else {
      ...
      render(text, record) {
          if (record.idNo == null) {
          	return (
                    <div title={record.idNo} style={{ textAlign: "left" }}>
                    	-                      	
                    </div>
               ) 
          } else {
      ...
      render(text, record) {
          if (record.education == null) {
          	return (
                    <div title={record.education} style={{ textAlign: "left" }}>
                    	-                      	
                    </div>
               ) 
          } else {
      ...
      render: (text, record) => {
        return <div>
          ...
          {record.state == "10" ? (
            <a href="javascript:;" onClick={me.disChangeStatus.bind(me, '解除黑名单', record)}>解除黑名单</a>
          ) : (
    ...
    return (
      <div className="block-panel">
        ...
        <AdjustCreditDetial ref="AdjustCreditDetial" blackVisible={state.blackVisible}   hideModal={me.hideModal} record={state.record} canEdit={state.canEdit} />       
      </div>
    );
  }
})