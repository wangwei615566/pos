...
let SeachForm = React.createClass({
    ...
    handleOut() {
        ...
        window.open("/modules/manage/payCheck/export.htm?searchParams="+encodeURIComponent(json));
    ...
    render() {
        ...
        return (
            <Form inline>
                <FormItem label="订单号:">
                    <Input onPressEnter={this.handleQuery} type="text" {...getFieldProps('orderNo') } />
                </FormItem>
                <FormItem label="对账时间:">
