                        ...
                        <Row>
                            <Col span="24">
                                <FormItem  {...formItemLayout} label="渠道编码:">
                                    <Input type="text" placeholder="请输入渠道编码" disabled={false} {...getFieldProps('code',{rules:[{ required: true, message: '未填或长度过长'}]})} />                                 
                                </FormItem>
                            </Col>
                            </Row>
                            <Row>
                            <Col span="24">
                                <FormItem  {...formItemLayout} label="渠道名称:">
                                    <Input type="text" placeholder="请输入渠道名称" disabled={!props.canEdit} {...getFieldProps('name',{rules:[{ required: true, message: '未填或长度过长'}]})} />                                 
                                </FormItem>
                            </Col>
                            </Row>
                            <Row>
                            <Col span="24">
                                <FormItem  {...formItemLayout} label="联系人:">
                                    <Input type="text" placeholder="请输入联系人" disabled={!props.canEdit} {...getFieldProps('linker',{rules:[{ required: true, message: '未填或长度过长'}]})} />                                 
                                </FormItem>
                            </Col>
                        </Row>
                        <Row>                         
                            <Col span="24">
                                <FormItem  {...formItemLayout} label="联系方式:">
                                    <Input type="text" placeholder="请输入联系方式" disabled={false} {...getFieldProps('phone',{rules:[{ required: true, message: '未填或长度过长'}]})} />                                 
                                </FormItem>
                            </Col>
                        </Row>
                </Form>
