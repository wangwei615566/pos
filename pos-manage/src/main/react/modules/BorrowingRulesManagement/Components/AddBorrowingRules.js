                ...
                ruleConfig.push(<Row key={j + '' + i}>
                    ...
                    <Col span="13">
                        <FormItem  {...formItemLayout} label="执行优先级:">
                            <InputNumber disabled={!props.canEdit} {...getFieldProps(`${j}${i}configSort`, { initialValue: sort[0] ? sort[i] : '0' }) } type="number" />
                        </FormItem>
                    </Col>
                ...
                <Row>
                    ...
                    <Col span="11" className='col_h'>
                        <FormItem  {...{
                            ...
                            <InputNumber disabled={!props.canEdit}  {...getFieldProps(`${k}ruleSort`, { initialValue: this.formData && this.formData[`${k}ruleSort`] ? this.formData[`${k}ruleSort`] : '0' }) } type="number" />
                        </FormItem>
                    </Col>
