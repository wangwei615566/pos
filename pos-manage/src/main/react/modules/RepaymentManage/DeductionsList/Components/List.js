    ...
    fetch(params = {}) {
        ...
        if (!params.pageSize) {
            ...
            params = {
                pageSize: 10,
                current: 1,
                search: JSON.stringify({startTime:year+'-'+month+'-'+day+' 00:00:00',endTime:year1+'-'+month1+'-'+day1+' 23:59:59',type: "20,40"})
            }
        }
        if(!params.search){
            params.search= JSON.stringify({startTime:year+'-'+month+'-'+day+' 00:00:00',endTime:year1+'-'+month1+'-'+day1+' 23:59:59',type:'20,40'})
        }
        Utils.ajaxData({
