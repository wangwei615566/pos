...
@Component
@Lazy(value = false)
public class QuartzHlbRepayment implements Job {

	private static final Logger logger = Logger.getLogger(QuartzHlbRepayment.class);
		...
		try {
			for (BorrowRepay borrowRepay : borrowRepayList) {
				...
				payLog.setOrderNo(orderNo);
	    			...
	    			payLog.setPayPlatform("3");//合利宝代扣平台
	...
	public void execute(JobExecutionContext context)
		...
		// 查询当前任务信息
		QuartzInfo quartzInfo = quartzInfoService.findByCode("doRepayment1");
